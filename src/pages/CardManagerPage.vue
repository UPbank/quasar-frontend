<template>
  <q-card>
  	<q-card-section >
      <div class="column justify-between bg-black text-white q-pa-md" style="border-radius:15px; aspect-ratio: 1.59; min-width: 250px;">
...
import { ref } from 'vue';
	...
	function ccFormat(num : number | string) {
		return num.toString().replace(/[^\dA-Z]/g, '').replace(/(.{4})/g, '$1 ').trim();
	}
